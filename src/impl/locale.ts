...
type EraCache = Map<StringUnitLength, string[]>;
...
export default class Locale {
  ...
  eras(length: StringUnitLength, defaultOK = true) {
    return listStuff(this, length, defaultOK, English.eras, len => {
      ...
      return this.eraCache.get(len) as string[];
    });
  }
  ...
  dtFormatter(dt: DateTime, intlOpts: DateTimeFormatOptions = {}) {
